    ...
    <div className="flex flex-col min-h-full">
      <div>
        ...
        <div className="px-5 lg:px-10 py-6 border-b border-solid border-primary-800">
          ...
          <p className="text-lg lg:text-xl tracking-wide">Earth, {convertCoordinatesDMS(geolocation.latitude)}, {convertCoordinatesDMS(geolocation.longitude)}</p>
          <Modal
        ...
        <div className="border-b border-solid border-primary-800 flex">
          <div className="w-1/2 px-5 lg:px-10 py-6 border-r border-solid border-primary-800">
            ...
            <p className="text-lg lg:text-xl tracking-wide">{sun.nauticalDawn.toLocaleTimeString()}</p>
          </div>
          <div className="w-1/2 px-5 lg:px-10 py-6">
            ...
            <p className="text-lg lg:text-xl tracking-wide">{sun.nauticalDusk.toLocaleTimeString()}</p>
          </div>
        </div>
        <div className="border-b border-solid border-primary-800 flex">
          <div className="w-1/2 px-5 lg:px-10 py-6 border-r border-solid border-primary-800">
